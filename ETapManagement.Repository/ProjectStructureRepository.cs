...
namespace ETapManagement.Repository
{
	...
	public class ProjectStructureRepository : IProjectStructureRepository
	{
		...
		public ResponseMessage AddProjectStructure(ProjectStructureDetails projectStructure)
		{
			...
			try
			{
				int count = _context.ProjectStructure.Count() + 1;
				string id = constantVal.ProjectStructureIdPrefix + count.ToString().PadLeft(6, '0');
				...
				{
					var projectStructureDb = _mapper.Map<ProjectStructure>(projectStructure);
					projectStructureDb.ProjStructId = id;
					_context.ProjectStructure.Add(projectStructureDb);
