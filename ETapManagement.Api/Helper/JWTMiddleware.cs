...
namespace ETapManagement.Api.Helper {
    public class JwtMiddleware {
        ...
        private readonly ETapManagement.ViewModel.Dto.AppSettings _appSettings;

        public JwtMiddleware (RequestDelegate next, IOptions<ETapManagement.ViewModel.Dto.AppSettings> appSettings) {
            _next = next;
