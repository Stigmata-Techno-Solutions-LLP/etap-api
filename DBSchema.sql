...
IF OBJECT_ID('ETapManagementSIT.dbo.scrap_status_history', 'U') IS NOT NULL 
...
-- Drop table
 ...
 IF  OBJECT_ID('ETapManagementSIT.dbo.disp_mod_stage_component', 'U') IS NOT NULL DROP TABLE ETapManagementSIT.dbo.disp_mod_stage_component ;
